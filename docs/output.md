...
- [Align](#align) - Minimap2 Alignment?
- [Busco](#multiqc) - Aggregate report describing results and QC from the whole pipeline
...
- `align/`
  - `*_aligned.bam`: FastQC report containing quality metrics.
